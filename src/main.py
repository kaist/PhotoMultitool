...
class App:
    ...
    def second_updater(self):
        if self.enable_poweroff and self.config['autooff_min'] and (time.time()-self.auto_off)>60*self.config['autooff_min']:
            Power.powerOff()
