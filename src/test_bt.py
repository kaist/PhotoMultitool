...
CHAR_RX_UUID = bluetooth.UUID("12345678-1234-5678-1234-56789abcdef1")  # клиент → сервер
CHAR_TX_UUID = bluetooth.UUID("12345678-1234-5678-1234-56789abcdef2")  # сервер → клиент
...
ble_server = BLEConfigServer(name="M5",iam='main_settings',config=config,message_callback=sv)

while True:
    ble_server.process_messages()